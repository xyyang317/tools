...
bbox_path1 = [os.path.join(input_ptah, t) for t in ['HiFT', 'TCTrack','HiT',]]
bbox_path2 = [os.path.join(input_ptah, t) for t in [ 'MixFormerV2', 'AutoTrack', 'ARCH-HC',  'F-SiamFC++', 'P-SiamFC++', 'TATrack']]
